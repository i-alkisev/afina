...
void ServerImpl::Start(uint16_t port, uint32_t n_accept, uint32_t n_workers) {
    ...
    _thread = std::thread(&ServerImpl::OnRunImpl2, this, server_socket);
    _thread.detach();
}
...
void ServerImpl::OnRunImpl2(int server_socket) {
    ...
    while (running.load()) {
        ...
        thread_pool.Execute(WorkerThreadImpl2, pStorage, _logger, client_socket);
    }
